...
function LunarUI:OnProfileChanged()
    ...
    if self.ApplyAllSavedPositions then
        local ok, err = pcall(self.ApplyAllSavedPositions)
...
local VALIDATION_RULES = {
    ...
    {
        path = "minimap.zoneFontOutline",
        type = "string",
        enum = { NONE = true, OUTLINE = true, THICKOUTLINE = true, MONOCHROMEOUTLINE = true },
    },
    {
        path = "minimap.coordFontOutline",
        type = "string",
        enum = { NONE = true, OUTLINE = true, THICKOUTLINE = true, MONOCHROMEOUTLINE = true },
    },
    -- 背包
