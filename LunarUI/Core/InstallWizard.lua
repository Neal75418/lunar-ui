...
local function BuildStep1(parent)
    ...
    scaleLabel:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE")
    ...
    scaleValue:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE")
    ...
    minLabel:SetFont(STANDARD_TEXT_FONT, 9, "")
    ...
    maxLabel:SetFont(STANDARD_TEXT_FONT, 9, "")
...
local function BuildStep3(parent)
    ...
    fadeLabel:SetFont(STANDARD_TEXT_FONT, 12, "")
    ...
    fadeDesc:SetFont(STANDARD_TEXT_FONT, 10, "")
...
local function BuildStep4(parent)
    ...
    summary:SetFont(STANDARD_TEXT_FONT, 12, "")
...
local function CreateWizardFrame()
    ...
    f.stepText:SetFont(STANDARD_TEXT_FONT, 10, "")
    ...
    closeBtn.text:SetFont(STANDARD_TEXT_FONT, 14, "OUTLINE")
